											...
											<div class="col-md-6 col-lg-6">
												...
												<div class="form-group">
													...
													<select name="status_pernikahan" class="form-control">
														<option disabled="" selected="">Pilih Status Warga</option>
														<option value="Kawin" <?php if($status_pernikahan=="Kawin") echo 'selected'?>>Sekolah</option>
											...
											<div class="col-md-6 col-lg-6">
												...
												<div class="form-group">
													...
													<select name="status_pernikahan" class="form-control">
														...
														<option value="Kawin" <?php if($status_warga=="Kawin") echo 'selected'?>>Sekolah</option>
														<option value="Belum Kawin" <?php if($status_warga=="Belum Kawin") echo 'selected'?>>Belum Kawin</option>
													</select>
												</div>
												<div class="form-group">
